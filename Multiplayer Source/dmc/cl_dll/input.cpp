...
{
	KeyDown(&in_attack2);
	gHUD.m_Spectator.HandleButtons( IN_ATTACK2 );
}

void IN_Attack2Up(void)
{
	KeyUp(&in_attack2);
	gHUD.m_Spectator.HandleButtons( 0 );
}
...
{
	KeyDown(&in_jump);
	gHUD.m_Spectator.HandleButtons( IN_JUMP );
}
...
{
	KeyDown(&in_duck);
	gHUD.m_Spectator.HandleButtons( IN_DUCK );
}
...
{
	KeyDown( &in_attack );
	gHUD.m_Spectator.HandleButtons( IN_ATTACK );
}
